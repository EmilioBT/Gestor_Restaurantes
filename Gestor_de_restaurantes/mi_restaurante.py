...
def recibo():
    ...
    texto_recibo.insert(END, f"*" * 47 + "\n")
    texto_recibo.insert(END, f"Esperamos su visita")
...
# Etiquita titulo
etique_titulo = Label(panel_superior, text='Sistema de Facturación', fg='azure4',
                      font=('Dosis', 58), bg='burlywood', width=20)
etique_titulo.grid(row=0, column=0)
...
# Panel comidas (no es una etiqueta, noe s un frame, es un cuadro que viene ya con la etiqueta incorporada)
panel_comidas = LabelFrame(panel_izquierdo, text='Comida', font=('Dosis', 19, 'bold'), bd=1, relief=FLAT, fg='azure4')
panel_comidas.pack(side=LEFT)

# Panel Bebidas (no es una etiqueta, no es un frame, es un cuadro que viene ya con la etiqueta incorporada)
panel_bebidas = LabelFrame(panel_izquierdo, text='Bebidas', font=('Dosis', 19, 'bold'), bd=1, relief=FLAT, fg='azure4')
panel_bebidas.pack(side=LEFT)

# Panel postres (no es una etiqueta, no es un frame, es un cuadro que viene ya con la etiqueta incorporada)
...
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mouse', 'pastel1', 'pastel2', 'pastel 3']
...
botones_calculadoras = ['7', '8', '9', '+', '4', '5', '6', '-',
                        '1', '2', '3', 'x', 'R', 'B', '0', '/']
botones_guardados = []
fila = 1
columna = 0
...
botones_guardados[12].config(command=obtener_resultados)
